...
> "Always curious, always reading, and convinced there's more to the story." 

I spent over four years in the banking sector learning that quality isn't a checkbox—it's a mindset. As a Senior Test Coordinator, I sat at the intersection of business logic and technical execution. The deeper I went, the more I realized that the answers to our biggest business questions were hidden in the data. 

Now, I'm ready to bring that exact same problem-solving mindset and eye for detail into a full-time Data Analyst role.

---

### 🚀 My Evolution
`Manual QA Tester` ➔ `QA Lead` ➔ `Test Coordinator` ➔ `Senior Test Coordinator`
🎯 **Next Step:** Data Analyst
---
